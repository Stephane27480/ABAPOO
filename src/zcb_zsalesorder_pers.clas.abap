class ZCB_ZSALESORDER_PERS definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_ZSALESORDER_PERS
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_ZSALESORDER_PERS .
  types:
...
CLASS ZCB_ZSALESORDER_PERS IMPLEMENTATION.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_ZSALESORDER_PERS.
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_ZSALESORDER_PERS,
...
* * ZSALESORDER: internal tables for mass operation
  data DB_ITB_ZSALESORDER type STANDARD TABLE OF ZSALESORDER.
  data DB_UTB_ZSALESORDER type STANDARD TABLE OF ZSALESORDER.
  data DB_DTB_ZSALESORDER type STANDARD TABLE OF ZSALESORDER.

* * ZSALESORDER: headlines for tables
  data DB_ILN_ZSALESORDER type ZSALESORDER.
  data DB_ULN_ZSALESORDER type ZSALESORDER.
  data DB_DLN_ZSALESORDER type ZSALESORDER.
...
*< Generated from mapping:
   ...
   DB_ILN_ZSALESORDER-SALESORG = <FS_INSERT>-SALESORG.
   DB_ILN_ZSALESORDER-CREATIONDATE = <FS_INSERT>-CREATIONDATE.
   DB_ILN_ZSALESORDER-CREATEDBY = <FS_INSERT>-CREATEDBY.
   DB_ILN_ZSALESORDER-LOEKZ = <FS_INSERT>-LOEKZ.


   DB_ILN_ZSALESORDER-SALESORDER = <FS_INSERT>-SALESORDER.
   append DB_ILN_ZSALESORDER to DB_ITB_ZSALESORDER.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZSALESORDER-SALESORG = <FS_UPDATE>-SALESORG.
   DB_ULN_ZSALESORDER-CREATIONDATE = <FS_UPDATE>-CREATIONDATE.
   DB_ULN_ZSALESORDER-CREATEDBY = <FS_UPDATE>-CREATEDBY.
   DB_ULN_ZSALESORDER-LOEKZ = <FS_UPDATE>-LOEKZ.


   DB_ULN_ZSALESORDER-SALESORDER = <FS_UPDATE>-SALESORDER.
   append DB_ULN_ZSALESORDER TO DB_UTB_ZSALESORDER.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZSALESORDER-SALESORDER = <FS_DELETE>-BUSINESS_KEY-SALESORDER.

    append DB_DLN_ZSALESORDER TO DB_DTB_ZSALESORDER.
...
* * DB Deletes
  delete ZSALESORDER FROM TABLE DB_DTB_ZSALESORDER.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZSALESORDER FROM TABLE DB_ITB_ZSALESORDER
...
* * DB Updates
  update ZSALESORDER FROM TABLE DB_UTB_ZSALESORDER.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZSALESORDER.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZSALESORDER> type ZSALESORDER.
*>
...
*< Generated from mapping:
  select * from ZSALESORDER
           ...
           where ZSALESORDER~SALESORDER = I_BUSINESS_KEY_TAB-SALESORDER.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZSALESORDER'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZSALESORDER>.

*< Generated from mapping:
    DB_DATA-SALESORDER = <FS_DB_ZSALESORDER>-SALESORDER.
    DB_DATA-SALESORG = <FS_DB_ZSALESORDER>-SALESORG.
    DB_DATA-CREATIONDATE = <FS_DB_ZSALESORDER>-CREATIONDATE.
    DB_DATA-CREATEDBY = <FS_DB_ZSALESORDER>-CREATEDBY.
    DB_DATA-LOEKZ = <FS_DB_ZSALESORDER>-LOEKZ.
*>
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_ZSALESORDER_PERS.
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDER'.
    MAP_ATT_INFO-FIELD_NAME1  = 'SALESORDER'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'SALESORG'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDER'.
    MAP_ATT_INFO-FIELD_NAME1  = 'SALESORG'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'LOEKZ'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDER'.
    MAP_ATT_INFO-FIELD_NAME1  = 'LOEKZ'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
*      RETURNING RESULT TYPE REF TO ZCL_ZSALESORDER_PERS
*       raising   CX_OS_OBJECT_NOT_FOUND
************************************************************************
