class ZCB_ZSALESORDERITEM_PERS definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      !I_SALESORDER type VBELN
      !I_SALESORDERITEM type POSNR
    returning
      value(RESULT) type ref to ZCL_ZSALESORDERITEM_PERS
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_ZSALESORDERITEM_PERS .
  types:
  ...
  types:
    begin of TYP_DB_DATA ,
      ...
      SALESORDERITEM type POSNR ,
      PRODUCT type MATNR ,
      ORDERQUANTITY type KWMENG ,
      ORDERQUANTITYUNIT type VRKME ,
      NETAMOUNT type NETWR_AP ,
      CURRENCYT type WAERS ,
...
CLASS ZCB_ZSALESORDERITEM_PERS IMPLEMENTATION.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_ZSALESORDERITEM_PERS.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->SALESORDER = I_BUSINESS_KEY-SALESORDER.
  NEW_OBJECT->SALESORDERITEM = I_BUSINESS_KEY-SALESORDERITEM.
* >
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_ZSALESORDERITEM_PERS,
...
*<  Generated from mapping:
  THE_OBJECT->SALESORDER = I_OBJECT_DATA-SALESORDER.
  THE_OBJECT->SALESORDERITEM = I_OBJECT_DATA-SALESORDERITEM.
  THE_OBJECT->PRODUCT = I_OBJECT_DATA-PRODUCT.
  THE_OBJECT->ORDERQUANTITY = I_OBJECT_DATA-ORDERQUANTITY.
  THE_OBJECT->ORDERQUANTITYUNIT = I_OBJECT_DATA-ORDERQUANTITYUNIT.
  THE_OBJECT->NETAMOUNT = I_OBJECT_DATA-NETAMOUNT.
  THE_OBJECT->CURRENCYT = I_OBJECT_DATA-CURRENCYT.
  THE_OBJECT->CREATIONDATE = I_OBJECT_DATA-CREATIONDATE.
  THE_OBJECT->CREATEDBY = I_OBJECT_DATA-CREATEDBY.
*>
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-SALESORDER.
  concatenate RESULT COMP_STRING into RESULT.
  COMP_STRING = I_BUSINESS_KEY-SALESORDERITEM.
  concatenate RESULT COMP_STRING into RESULT.
*>
...
* * ZSALESORDERITEM: internal tables for mass operation
  data DB_ITB_ZSALESORDERITEM type STANDARD TABLE OF ZSALESORDERITEM.
  data DB_UTB_ZSALESORDERITEM type STANDARD TABLE OF ZSALESORDERITEM.
  data DB_DTB_ZSALESORDERITEM type STANDARD TABLE OF ZSALESORDERITEM.

* * ZSALESORDERITEM: headlines for tables
  data DB_ILN_ZSALESORDERITEM type ZSALESORDERITEM.
  data DB_ULN_ZSALESORDERITEM type ZSALESORDERITEM.
  data DB_DLN_ZSALESORDERITEM type ZSALESORDERITEM.
...
*< Generated from mapping:
   ...
   DB_ILN_ZSALESORDERITEM-PRODUCT = <FS_INSERT>-PRODUCT.
   DB_ILN_ZSALESORDERITEM-ORDERQUANTITY = <FS_INSERT>-ORDERQUANTITY.
   DB_ILN_ZSALESORDERITEM-ORDERQUANTITYUNIT =
   <FS_INSERT>-ORDERQUANTITYUNIT.
   DB_ILN_ZSALESORDERITEM-NETAMOUNT = <FS_INSERT>-NETAMOUNT.
   DB_ILN_ZSALESORDERITEM-CURRENCYT = <FS_INSERT>-CURRENCYT.
   DB_ILN_ZSALESORDERITEM-CREATIONDATE = <FS_INSERT>-CREATIONDATE.
   DB_ILN_ZSALESORDERITEM-CREATEDBY = <FS_INSERT>-CREATEDBY.


   DB_ILN_ZSALESORDERITEM-SALESORDER = <FS_INSERT>-SALESORDER.
   DB_ILN_ZSALESORDERITEM-SALESORDERITEM = <FS_INSERT>-SALESORDERITEM.
   append DB_ILN_ZSALESORDERITEM to DB_ITB_ZSALESORDERITEM.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZSALESORDERITEM-PRODUCT = <FS_UPDATE>-PRODUCT.
   DB_ULN_ZSALESORDERITEM-ORDERQUANTITY = <FS_UPDATE>-ORDERQUANTITY.
   DB_ULN_ZSALESORDERITEM-ORDERQUANTITYUNIT =
   <FS_UPDATE>-ORDERQUANTITYUNIT.
   DB_ULN_ZSALESORDERITEM-NETAMOUNT = <FS_UPDATE>-NETAMOUNT.
   DB_ULN_ZSALESORDERITEM-CURRENCYT = <FS_UPDATE>-CURRENCYT.
   DB_ULN_ZSALESORDERITEM-CREATIONDATE = <FS_UPDATE>-CREATIONDATE.
   DB_ULN_ZSALESORDERITEM-CREATEDBY = <FS_UPDATE>-CREATEDBY.


   DB_ULN_ZSALESORDERITEM-SALESORDER = <FS_UPDATE>-SALESORDER.
   DB_ULN_ZSALESORDERITEM-SALESORDERITEM = <FS_UPDATE>-SALESORDERITEM.
   append DB_ULN_ZSALESORDERITEM TO DB_UTB_ZSALESORDERITEM.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZSALESORDERITEM-SALESORDER =
    <FS_DELETE>-BUSINESS_KEY-SALESORDER.
    DB_DLN_ZSALESORDERITEM-SALESORDERITEM =
    <FS_DELETE>-BUSINESS_KEY-SALESORDERITEM.

    append DB_DLN_ZSALESORDERITEM TO DB_DTB_ZSALESORDERITEM.
...
* * DB Deletes
  delete ZSALESORDERITEM FROM TABLE DB_DTB_ZSALESORDERITEM.
  if SY-SUBRC <> 0.
    raise exception type CX_OS_DB_DELETE
      exporting
        TABLE = 'ZSALESORDERITEM'.
  endif.

* * DB Inserts
  insert ZSALESORDERITEM FROM TABLE DB_ITB_ZSALESORDERITEM
...
* * DB Updates
  update ZSALESORDERITEM FROM TABLE DB_UTB_ZSALESORDERITEM.
  if SY-SUBRC <> 0.
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-SALESORDER = BUSINESS_KEY-SALESORDER.
    <FS_OBJECT_DATA>-SALESORDERITEM = BUSINESS_KEY-SALESORDERITEM.
*>
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZSALESORDERITEM.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZSALESORDERITEM> type ZSALESORDERITEM.
*>

*< Generated from mapping:
  select * from ZSALESORDERITEM
           into table DB_DATA_LOCAL_TAB
           for all entries in I_BUSINESS_KEY_TAB
           where ZSALESORDERITEM~SALESORDER =
           I_BUSINESS_KEY_TAB-SALESORDER
             and ZSALESORDERITEM~SALESORDERITEM =
             I_BUSINESS_KEY_TAB-SALESORDERITEM.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZSALESORDERITEM'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZSALESORDERITEM>.

*< Generated from mapping:
    DB_DATA-SALESORDER = <FS_DB_ZSALESORDERITEM>-SALESORDER.
    DB_DATA-SALESORDERITEM = <FS_DB_ZSALESORDERITEM>-SALESORDERITEM.
    DB_DATA-PRODUCT = <FS_DB_ZSALESORDERITEM>-PRODUCT.
    DB_DATA-ORDERQUANTITY = <FS_DB_ZSALESORDERITEM>-ORDERQUANTITY.
    DB_DATA-ORDERQUANTITYUNIT =
    <FS_DB_ZSALESORDERITEM>-ORDERQUANTITYUNIT.
    DB_DATA-NETAMOUNT = <FS_DB_ZSALESORDERITEM>-NETAMOUNT.
    DB_DATA-CURRENCYT = <FS_DB_ZSALESORDERITEM>-CURRENCYT.
    DB_DATA-CREATIONDATE = <FS_DB_ZSALESORDERITEM>-CREATIONDATE.
    DB_DATA-CREATEDBY = <FS_DB_ZSALESORDERITEM>-CREATEDBY.
*>
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_ZSALESORDERITEM_PERS.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->SALESORDER,
             THE_OBJECT->SALESORDERITEM,
             THE_OBJECT->PRODUCT,
             THE_OBJECT->ORDERQUANTITY,
             THE_OBJECT->ORDERQUANTITYUNIT,
             THE_OBJECT->NETAMOUNT,
             THE_OBJECT->CURRENCYT,
             THE_OBJECT->CREATIONDATE,
             THE_OBJECT->CREATEDBY.
*>
...
************************************************************************
  ...
  if MAP_ATT_INFO_TAB is initial.
    ...
    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'SALESORDER'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDERITEM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'SALESORDER'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'SALESORDERITEM'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDERITEM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'SALESORDERITEM'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'PRODUCT'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDERITEM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'PRODUCT'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ORDERQUANTITY'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDERITEM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ORDERQUANTITY'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'ORDERQUANTITYUNIT'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDERITEM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'ORDERQUANTITYUNIT'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'NETAMOUNT'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDERITEM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'NETAMOUNT'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CURRENCYT'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDERITEM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CURRENCYT'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CREATIONDATE'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDERITEM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CREATIONDATE'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.

    clear MAP_ATT_INFO.
    MAP_ATT_INFO-NAME = 'CREATEDBY'.
    MAP_ATT_INFO-EXPOSURE = '2'.
    MAP_ATT_INFO-RECORDNAME = 'ZSALESORDERITEM'.
    MAP_ATT_INFO-FIELD_NAME1  = 'CREATEDBY'.
    insert MAP_ATT_INFO into table MAP_ATT_INFO_TAB.
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-SALESORDER = THE_OBJECT->SALESORDER.
    OBJECT_DATA_ITEM-SALESORDERITEM = THE_OBJECT->SALESORDERITEM.
    OBJECT_DATA_ITEM-PRODUCT = THE_OBJECT->PRODUCT.
    OBJECT_DATA_ITEM-ORDERQUANTITY = THE_OBJECT->ORDERQUANTITY.
    OBJECT_DATA_ITEM-ORDERQUANTITYUNIT = THE_OBJECT->ORDERQUANTITYUNIT.
    OBJECT_DATA_ITEM-NETAMOUNT = THE_OBJECT->NETAMOUNT.
    OBJECT_DATA_ITEM-CURRENCYT = THE_OBJECT->CURRENCYT.
    OBJECT_DATA_ITEM-CREATIONDATE = THE_OBJECT->CREATIONDATE.
    OBJECT_DATA_ITEM-CREATEDBY = THE_OBJECT->CREATEDBY.
*>
...
*<Generated from mapping:
  E_BUSINESS_KEY-SALESORDER  = I_DB_DATA-SALESORDER.
  E_BUSINESS_KEY-SALESORDERITEM  = I_DB_DATA-SALESORDERITEM.
*>
...
*< Generated from mapping:
  call method CREATE_TRANSIENT
       exporting I_SALESORDER = BUSINESS_KEY-SALESORDER
                 I_SALESORDERITEM = BUSINESS_KEY-SALESORDERITEM
...
***BUILD 093901
*      IMPORTING I_SALESORDER TYPE VBELN.
*      IMPORTING I_SALESORDERITEM TYPE POSNR.
*      RETURNING RESULT TYPE REF TO ZCL_ZSALESORDERITEM_PERS
*       raising   CX_OS_OBJECT_NOT_FOUND
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-SALESORDER = I_SALESORDER.
  BUSINESS_KEY-SALESORDERITEM = I_SALESORDERITEM.
*>
...
*<  Generated from mapping:
          THE_OBJECT->SALESORDER = I_SALESORDER.
          THE_OBJECT->SALESORDERITEM = I_SALESORDERITEM.
*>
